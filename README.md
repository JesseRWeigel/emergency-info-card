...
Wallet card and lock-screen image with the facts a first responder needs, regenerated for every family member from one local file

Catalog task: `HLTH-035`. One of a public catalog of build ideas: https://github.com/JesseRWeigel/722-things-to-build
